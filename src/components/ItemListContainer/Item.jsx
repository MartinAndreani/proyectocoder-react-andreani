...
const Item = ({id,title,image,price,stock}) => {
  ...
  return (
    <div className='flex justify-center' >
      <div className= '  w-4/5 bg-gray-400  border-2  border-black-400 shadow-3xl rounded-xl hover:-translate-y-1 hover:scale-110 duration-300'>
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
          ...
          <div className="px-6 pt-4 pb-2 flex justify-center">
            <Link to={`/item/${id}`}>
              <button className='bg-indigo-300  h-8 font-serif w-32 rounded-xl hover:-translate-y-1 hover:scale-110 duration-300 hover:bg-teal-200'>Ver Detalle</button>
            </Link>
          </div>
      </div>
